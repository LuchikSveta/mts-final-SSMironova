...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, AssemblyMessage> assemblyMessageConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(consumerProps, new StringDeserializer(), new JsonDeserializer<>(AssemblyMessage.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AssemblyMessage> assemblyMessageKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, AssemblyMessage> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(assemblyMessageConsumerFactory());
        return factory;
    }
